...
export const soundsTypes = [
	...
	"garo/battlebonus3000",
	"garo/fog_bare",
	"garo/gfog_kansei",
	"garo/pfog_navigation",
	"garo/pfog_shutsugen",
	"garo/pfog_shutsugen",
	"garo/throughoutbonus_keizoku",
	"garo/impact_honoo",
	"garo/impact_zanbaken",
	"garo/garo_flash",
	"garo/garo_horyuu",
	"garo/sp_reach_title_red1",
	"garo/sp_reach_title_red2",
	"garo/sp_reach_tenun",
	"garo/garoken_pushed",
	"garo/garoken_tobidashi",
	"garo/garoken_tobidashi2",
	"garo/garoken_horyuu",
	"garo/garozanbaken_tobidashi",
	"garo/garozanbaken_horyuu",
	"garo/gekkou_special_bonus3000",
	"garo/genkai_sokuhagyaku_emblem",
	"garo/shoukaku_victory7",
	"garo/shoukaku_gekkou_special_bonus3000",
	"garo/shoukaku_zugara_seikou",
	"garo/hendoukaishi_emblem_chance",
	"garo/hendoukaishi_emblem_gekiatsu",
	"garo/reijuurin_garo",
	"garo/grenzokuyokoku_title_victory",
	"garo/fog_kansei",
	"garo/fog_kansei_ooatari",
	"garo/garo_bonus_max",
	"garo/garo_logo_flash_red",
	"garo/garos_eyes_red",
	"garo/sansei_flash",
] as const;
